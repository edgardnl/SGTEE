...
class TutoresSql {
    ...
    function agregaTutores() {
        $query = "insert into tutor(clave,nombre,ap_p,ap_m,asignatura,horario) values(?,?,?,?,?,?);";
        return $query;
    }
    ...
    function editaDatosTutor($obj){
        $query = "update tutor set clave = '".$obj->clave."', nombre = '".$obj->nombre."', ap_p = '".$obj->ap_p."', ap_m = '".$obj->ap_m."', asignatura = '".$obj->asignatura."',horario = '".$obj->horaio."' where id_tutores = ".$obj->id.";";
        return $query;
    }
