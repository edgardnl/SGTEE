					...
					<h3 class="blank1">Editar Tutores</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" class="form-control1" id="focusedinput" placeholder="" value="<?php print $objT->asignatura; ?>" name="asig">
									</div>
								...
								<div class="panel-footer">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-8 col-sm-offset-2">
                                                                            ...
                                                                            <button class="btn-success btn" onclick="eliminarTutor()">Eliminar</button>
