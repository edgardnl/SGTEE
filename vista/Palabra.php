...
<script type="text/javascript">
	$(document).ready(function() {
    	...
    	$("#agregar").click(function(){
    		...
    		var datos = "action=cambiaPassTutor&" + $("#FormPass").serialize();
		    //alert(datos);
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">											
										 <div class="user-name">
											<p><?php print $_SESSION["nom"]; ?><span>Administrador</span></p>
										 </div>										 
						...
						<div class="tab-pane active" id="horizontal-form">
                            ...
                            <form class="form-horizontal" name="FormPass" id="FormPass">
									...
									<div class="col-sm-8">
                                                                            ...
                                                                            <input type="hidden" class="form-control1" id="usu" placeholder="" name="usu" value="<?php print $_GET["id"]; ?>">
									</div>
